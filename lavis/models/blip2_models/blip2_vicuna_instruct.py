...
class Blip2VicunaInstruct(Blip2Base):
    ...
    def __init__(
        ...
        self.llm_tokenizer = LlamaTokenizer.from_pretrained("lmsys/vicuna-7b-v1.5", use_fast=False, truncation_side="left")
    ...
    def forward(self, samples):
        ...
        with self.maybe_autocast():
            image_embeds = self.ln_vision(self.visual_encoder(image,q_types))
