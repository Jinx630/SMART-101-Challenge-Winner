...
from lavis.datasets.datasets.multimodal_classification_datasets import MultimodalClassificationDataset
...
@registry.register_builder("smart")
class SMARTBuilder(BaseDatasetBuilder):
    train_dataset_cls = MultimodalClassificationDataset
    eval_dataset_cls = MultimodalClassificationDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/smart/defaults.yaml"}
